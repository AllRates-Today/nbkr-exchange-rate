// National Bank of the Kyrgyz Republic exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/nbkr';
...
/** Latest rate for one pair, e.g. getRate('USD', 'KGS', { apiKey }). */
